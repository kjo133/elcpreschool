...
<!-- <div id="pageContainer"> -->
	...
	<div class="container" style="border: solid blue;">
		...
		<div class="row" style="border: solid yellow 2px;">
			<div class="col-sm-3">
		    	<div class="sidebar-nav customWidthNav" style="border: solid blue 2px;">
		 ...
		 <div class="col-sm-9">
		    <!--Main content goes here-->
			  ...
			  <div id="contentContainer" style="border: solid purple;">
